...
class EnvironmentManager:
    def __init__(self, width, height):
        ...
        # Environment Setting
        self.background_layer_1 = pygame.transform.scale(pygame.image.load(r'D:\my program\New Projects\py\ZombieZapper\Game_Assets\4. Background Art\Layer 3.PNG'), (width, height)).convert_alpha()
        self.background_layer_2 = pygame.transform.scale(pygame.image.load(r'D:\my program\New Projects\py\ZombieZapper\Game_Assets\4. Background Art\Layer 2.PNG'), (width, height)).convert_alpha()
        self.background_layer_3 = pygame.transform.scale(pygame.image.load(r'D:\my program\New Projects\py\ZombieZapper\Game_Assets\4. Background Art\Layer 1.PNG'), (width, height)).convert_alpha()

        self.foreground_layer_1 = pygame.image.load(r'D:\my program\New Projects\py\ZombieZapper\Game_Assets\3. Foreground Artr\Bunker.PNG').convert_alpha()
        ...
        self.foreground_layer_2 = pygame.image.load(r'"D:\my program\New Projects\py\ZombieZapper\Game_Assets\3. Foreground Art\Bunker.PNG"').convert_alpha()
        ...
        self.foreground_layer_3 = pygame.image.load(r'D:\my program\New Projects\py\ZombieZapper\Game_Assets\3. Foreground Art\Ground.PNG').convert_alpha()
        ...
        self.foreground_layer_4 = pygame.image.load(r'D:\my program\New Projects\py\ZombieZapper\Game_Assets\3. Foreground Art\Platform.PNG').convert_alpha()
        ...
        # Load crypto images
        self.crypto_images = [pygame.image.load(fr'D:\my program\New Projects\py\ZombieZapper\Game_Assets\3. Foreground Art\Cryo Pod\Cryo{i}.PNG').convert_alpha() for i in range(1, 14)]
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.run_frames = [pygame.image.load(fr"D:\my program\New Projects\py\ZombieZapper\Game_Assets\1.MainCharacterArt\Animations\Run\Run{i}.PNG").convert_alpha() for i in range(1, 7)]
        self.jump_frames = [pygame.image.load(fr"D:\my program\New Projects\py\ZombieZapper\Game_Assets\1.MainCharacterArt\Animations\Jump\Jump{i}.PNG").convert_alpha() for i in range(1, 3)]
        self.character_image = self.run_frames[0]
        self.image = self.character_image
        self.rect = self.image.get_rect(midbottom=(400, 640))
        self.current_frame = 0
        self.gun_image = pygame.image.load(r"D:\my program\New Projects\py\ZombieZapper\Game_Assets\1.MainCharacterArt\Model & Weapon\Gun.PNG").convert_alpha()
...
class SpawnAnimation(pygame.sprite.Sprite):
    def __init__(self, x, y):
        super().__init__()
        self.spawn_images = [pygame.image.load(fr'D:\my program\New Projects\py\ZombieZapper\Game_Assets\2.Enemies\EnemySpawn\Spawn{i}.PNG').convert_alpha() for i in range(1, 8)]
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self, x, y):
        super().__init__()
        self.original_images = [pygame.image.load(fr'D:\my program\New Projects\py\ZombieZapper\Game_Assets\2.Enemies\Enemy2\Enemy2_{i}.PNG').convert_alpha() for i in range(1, 7)]
...
class AnotherEnemy(pygame.sprite.Sprite):
    def __init__(self, x, y):
        super().__init__()
        self.original_images = [pygame.image.load(fr'D:\my program\New Projects\py\ZombieZapper\Game_Assets\2.Enemies\Enemy1\Enemy1_{i}.PNG').convert_alpha() for i in range(1, 7)]
        self.images = self.original_images.copy()
        self.image = self.images[0]
        self.rect = self.image.get_rect(midbottom=(x, y))
        self.animation_count = 0
...
class BulletAnimation:
    def __init__(self) -> None:
        # Bullet Settings
        self.bullet_image = pygame.image.load(r"D:\my program\New Projects\py\ZombieZapper\Game_Assets\1.MainCharacterArt\Model & Weapon\Bullet.PNG").convert_alpha()
...
class SoundManager:
    def __init__(self):
        ...
        # Load sounds
        self.main_sound = pygame.mixer.Sound(r"D:\my program\New Projects\py\ZombieZapper\Game_Assets\5. Music\Enigma-Long-Version-Complete-Version(chosic.com).mp3")
        self.gun_shot_sound = pygame.mixer.Sound(r"D:\my program\New Projects\py\ZombieZapper\Game_Assets\6. Sound Affects\Gunshot.wav")
        self.spawn_animation_sound = pygame.mixer.Sound(r"D:\my program\New Projects\py\ZombieZapper\Game_Assets\6. Sound Affects\EnemySpawn.wav")
        self.jump_sound = pygame.mixer.Sound(r"D:\my program\New Projects\py\ZombieZapper\Game_Assets\6. Sound Affects\Jump.wav")
