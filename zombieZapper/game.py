...
class game:
    ...
    def show_menu(self):
        self.menu = pygame.transform.scale(pygame.image.load(r'D:\my program\New Projects\py\ZombieZapper\Game_Assets\4. Background Art\full_menu.jpg'), (settings.WIDTH, settings.HEIGHT)).convert_alpha()
    ...
    def run(self):
        ...
        while running:
            ...
            if self.in_menu:
                ...
                self.font = pygame.font.Font(r'D:\my program\New Projects\py\ZombieZapper\Game_Assets\font\BD_Cartoon_Shout.ttf', 25)
                ...
                # Game over screen
                self.game_over = pygame.transform.scale(pygame.image.load(r'D:\my program\New Projects\py\ZombieZapper\Game_Assets\4. Background Art\restart.jpg'), (settings.WIDTH, settings.HEIGHT)).convert_alpha()
                self.display.screen.blit(self.game_over, (0,0))
                
                self.font = pygame.font.Font(r'D:\my program\New Projects\py\ZombieZapper\Game_Assets\font\BD_Cartoon_Shout.ttf', 45)
